    ...
    <div class="container-fluid bg-white shadow pt-2 pb-2 mt-3">
        <center>
            ...
            <div class="text-center">
                ...
                <small class="text-dark "><i class="fa-solid fa-cloud"></i>&nbsp;  <a href="https://discord.gg/BFuEmqUgPq" class="text-dark">discord</a></small>
                <small class="text-dark "><i class="fa-solid fa-cloud"></i>&nbsp;  <a href="https://www.youtube.com/channel/UCDMZNDdGHb2sknBnQKKX7fg" class="text-dark">YouTube</a></small>
				</p>
